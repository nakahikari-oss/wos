...
> 寒霜啟示錄（Whiteout Survival）中英文遊戲術語對照。
> **每次做英文版攻略前，先查這份表；表上沒有的詞，查證後再加進來。**
>
> 來源優先順序：① 遊戲內畫面 → ② 官方 Wiki 中英對照 → ③ 詢問克菈莉絲確認
> 官方 Wiki：https://www.whiteoutsurvival.wiki/ ｜ 中文版：https://www.whiteoutsurvival.wiki/tw/

---

## 活動 / Events

| 中文（遊戲內） | English（遊戲內） | 備註 |
|---|---|---|
...
| 明月的盛典 | _（待確認）_ | 中秋節限時活動（2026/9/21–9/27），賓果玩法 |
| 望月商店 | _（待確認）_ | 明月的盛典的兌換商店 |

### 明月的盛典相關 / Moonlight Festival Terms
| 中文 | English | 備註 |
|---|---|---|
| 妙解千機 | _（待確認）_ | 5×5 賓果小遊戲，從 1–50 抽 25 個數字組成數陣 |
| 盈月之章 | _（待確認）_ | 活動代幣，用於望月商店 |
| 燈籠 | _（待確認）_ | 玩妙解千機的消耗品，1 個燈籠抽 1 個數字 |
| 祝福明燈 | _（待確認）_ | 獎池吐回的燈籠；「放飛明燈」＝抽一次 |
| 燈彩映月華 | _（待確認）_ | 任務進度條，有 $5 / $10 兩個解鎖包（$10 需先買 $5） |
| 流光的樂章 | _（待確認）_ | 額外任務板，有一格需購買任一 ≥$5 的禮包 |
| 名片榜 | _（待確認）_ | 每日積分榜，拿滿給 30 燈籠，零課也能滿 |
| 普通數陣 / 百變數陣 / 千幻數陣 | _（待確認）_ | 妙解千機的三級獎勵等級，獎勵約為 1 : 3 : 6 倍 |
| 霜色祝福 | _（見銀霜商鋪段）_ | ⚠️ 不同活動的通行證名稱不同，勿混用 |

### 漫遊劇場相關 / Wandering Theater Terms
| 中文 | English | 備註 |
|---|---|---|
| 寒冰護符 | _（待確認）_ | 漫遊劇場升層消耗的道具 |
...
| 照明燈 | Lantern | 衝高分關鍵道具，深度 >300m 視野靠它 |
| 魚線穩定器 | Reel Stabilizer | 釣魚輔助道具 |
...
### 城市建築 / City Buildings（玩家自己的城市內，所有活動通用）
| 中文 | English | 備註 |
|---|---|---|
| 熔爐 | Furnace | 主城建築。⚠️ 玩家社群常稱「火城」，但官方/本站一律用「熔爐」 |
| 大使館 | Embassy | |
| 指揮部 | Command Center | |
| 盾兵營 | Infantry Camp | |
| 矛兵營 | Lancer Camp | |
...
|---|---|---|
| 領主 | Chief | 玩家自己的城主稱呼 |
| 盟主 | Alliance Leader | = R5 |
| R4 / R5 | R4 / R5 | 聯盟階級，國際通用 |
| 指揮官（戰場指揮官） | Commander | 峽谷會戰職務。**負責任命守護者、管理燃料調度，本身不下戰場指令**。雖然頭銜叫「指揮官」聽起來像戰場總指揮，但實際上是後勤角色 — 影片裡「不要被名稱誤導」就是在說這件事。⚠️ 英文 in-game UI 推測為 Commander（與 Wiki 英文版一致），待克菈莉絲下次進遊戲確認 |
| 守護者 | Guardian | 峽谷會戰職務。**被指揮官任命後進入建物實際補燃料**。補油速度依建物等級不同 |
| 軍團 | Legion | 峽谷會戰中分組成「軍團1、軍團2」= Legion 1, Legion 2 |

## 其他術語 / Misc（UI、動作、機制、計分）
...
| 燃料 / 油（兩個中文交替用） | Fuel | |
| 冷卻狀態 | cooldown state | 離開戰場後 12 分鐘 |

### 計分 / Scoring
| 中文 | English | 備註 |
|---|---|---|
| 積分 | Points | ⚠️ 曾誤用 Score，已修正 |
| 個人戰功 | personal merit | 與「積分」是不同的計分項目，要區分清楚 |
| 個人排名獎勵 | Personal Ranking Rewards | |
| 聯盟排名獎勵 | Alliance Ranking Rewards | |
| 輪空獎勵 | bye-round rewards | |

### 其他
| 中文 | English | 備註 |
|---|---|---|
| 峽谷商店 | Canyon Shop | 峽谷會戰專屬商店 |
